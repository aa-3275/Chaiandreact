      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div
            ...
            id="mobile-menu-2"
          >
            {/* flex-col hata diya aur flex-row laga diya, space-x-4 add kiya taaki chipke na rahein */}
            <ul className="flex flex-row mt-4 font-medium lg:space-x-8 lg:mt-0 space-x-4">
              <li>
                <NavLink
                  to="/"
                  className={({ isActive }) =>
